...
Business.create company_name: 'Origins', email: 'ceo@origins.com', password: '123456789', password_confirmation: '123456789', category: grocery_health_and_beauty, avatar: seed_image('adidas_origs.gif')
